from flask import Flask,session, render_template, request, redirect,flash,send_file, url_for,send_from_directory, jsonify, json
...
def send_notification():
    ...
    return jsonify({'message': f'Message sent to {sent_count} out of {len(students_to_notify)} students with attachments (if any)'}), 200
